...
def get_terms_and_conditions(terms):
	return frappe.db.get_value("Terms and Conditions", terms, "terms")


def get_payment_terms():
	return frappe.db.get_all("Payment Terms Template", fields=["name"])
